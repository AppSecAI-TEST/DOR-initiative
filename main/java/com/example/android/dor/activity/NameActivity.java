...
public class NameActivity extends AppCompatActivity {
    ...
    private static final String Change_Username_URL = "https://dor-rubai.c9users.io/saveChanges/saveName.php ";
    EditText usrname;
    ...
    private class ChangeUserName extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(NameActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (success) {
                    Toast.makeText(NameActivity.this, msg , Toast.LENGTH_SHORT).show();
